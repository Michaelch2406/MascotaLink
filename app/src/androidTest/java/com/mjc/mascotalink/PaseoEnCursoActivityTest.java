...
/**
 * Pruebas Espresso para PaseoEnCursoActivity
 * Verifica que la Activity se inicializa correctamente
 */
@RunWith(AndroidJUnit4.class)
public class PaseoEnCursoActivityTest {

    @Test
    public void testActivityLaunches() {
        ActivityScenario.launch(PaseoEnCursoActivity.class);
    }

    @Test
    public void testActivityInitializes() {
        ActivityScenario<PaseoEnCursoActivity> scenario = ActivityScenario.launch(PaseoEnCursoActivity.class);
    ...
    public void testActivityDoesNotCrash() {
        try {
            ...
            throw new AssertionError("PaseoEnCursoActivity crashed: " + e.getMessage());
        }
    }
