...
public class PaseosActivity extends AppCompatActivity {
    ...
    // Clase interna Paseo (sin cambios)
    public static class Paseo {
        // ... (Mantener estructura existente para Firebase serialization)
        ...
        private DocumentReference id_dueno;
        private DocumentReference id_paseador;
        private Date fecha;
        ...
        // Getters & Setters necesarios para el Adapter
        ...
        public DocumentReference getId_dueno() { return id_dueno; } // Needed for serializing
        public void setId_dueno(DocumentReference ref) { this.id_dueno = ref; }
        public DocumentReference getId_paseador() { return id_paseador; } // Needed for serializing
