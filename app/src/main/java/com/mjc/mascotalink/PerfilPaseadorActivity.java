...
public class PerfilPaseadorActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void setupListeners() {
        ...
        btnCerrarSesion.setOnClickListener(v -> {
            ...
            AlertDialog progressDialog = new AlertDialog.Builder(PerfilPaseadorActivity.this)
                    .setView(dialogView)
                    .setCancelable(false)
                    .create();
            ...
            new Thread(() -> {
                try {
                    ...
                    com.mjc.mascotalink.util.BottomNavManager.clearUserRole(PerfilPaseadorActivity.this);
                    ...
                    runOnUiThread(() -> {
                        ...
                        Toast.makeText(PerfilPaseadorActivity.this, "Error al cerrar sesión. Inténtalo de nuevo.", Toast.LENGTH_SHORT).show();
